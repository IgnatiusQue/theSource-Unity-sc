...
public class PlayerPrefsControl : MonoBehaviour
{
   ...
   */
    private  readonly string PRIVATE_KEY_PREFIX = "abcd";
    private  readonly string PRIVATE_KEY_RAND = "efg";
    private  readonly string PRIVATE_KEY_SUFFIX = "h";
    ...
    private  readonly string RAND_KEY = "abcdefgh";

    // Should errors/exceptions be logged.
    private  bool logErrorsEnabled = false;
	 ...
	 */
    private   void securePlayerPrefs(string[,] keynames, bool deleteOldKeys)
    {
	 ...
	 */
    public   void setLogErrorsEnabled(bool state)
    {
